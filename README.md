...
learn to build 3 projects with Secretgardens at [24 Hour MVP](https://founderhacker.com/24-hour-mvp), or check out the [premium documentation](https://gitpaywall.com/p/ryanckulp/speedrail-docs).

**Secretgardens features**
* rich text blog CMS
...
**For detailed, step by step tutorials to using Secretgardens, get lifetime access to the [Secretgardens Docs](https://gitpaywall.com/p/ryanckulp/speedrail-docs) for a one-time fee of $49.**
...
To sync your project with the latest Secretgardens improvements:

```sh
# one time only
git remote add speedrail https://github.com/ryanckulp/speedrail.git

# when you notice Secretgardens updates on GitHub
git pull
git fetch speedrail
